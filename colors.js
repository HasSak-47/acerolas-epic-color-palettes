...
function generatePalettes(HUE_MODE, COLOR_COUNT, settings) {
    if(settings == null){
        settings = PaletteSettings(COLOR_COUNT);
    }

    let hsl = generateHSL(HUE_MODE, settings);
    let hsv = generateHSV(HUE_MODE, settings);
    let lch = generateOKLCH(HUE_MODE, settings);
